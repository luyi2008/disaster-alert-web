...
const PROVIDERS: Array<{
  ...
  { id: "wechat", label: "微信", enabled: true, unavailable: "" },
  { id: "alipay", label: "支付宝", enabled: false, unavailable: "支付宝登录本期暂未开放" },
  { id: "google", label: "Google", enabled: false, unavailable: "Google 登录本期暂未开放" },
];
...
function SocialIcon({ id }: { id: SocialProvider }) {
  ...
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
      <path fill="currentColor" d="M21.6 12.23c0-.74-.07-1.45-.19-2.13H12v4.03h5.4a4.62 4.62 0 0 1-2 3.03v2.5h3.24c1.9-1.75 2.96-4.33 2.96-7.43Z" />
      <path fill="currentColor" d="M12 22c2.7 0 4.96-.89 6.62-2.42l-3.24-2.5c-.9.6-2.05.96-3.38.96-2.6 0-4.8-1.76-5.59-4.12H3.07v2.58A9.99 9.99 0 0 0 12 22Z" />
      <path fill="currentColor" d="M6.41 13.92A6 6 0 0 1 6.1 12c0-.67.12-1.31.31-1.92V7.5H3.07A9.99 9.99 0 0 0 2 12c0 1.61.39 3.14 1.07 4.5l3.34-2.58Z" />
      <path fill="currentColor" d="M12 5.96c1.47 0 2.79.5 3.82 1.5l2.87-2.87C16.95 2.97 14.7 2 12 2A9.99 9.99 0 0 0 3.07 7.5l3.34 2.58C7.2 7.72 9.4 5.96 12 5.96Z" />
    </svg>
  );
}
