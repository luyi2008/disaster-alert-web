...
export function queryElements(root: HTMLElement): SubscribeElements {
  return {
    ...
    statusSourceList: requiredQuery(root, "#status-source-list"),
    statusChipWolfx: requiredQuery(root, "#status-chip-wolfx"),
    statusChipFanstudio: requiredQuery(root, "#status-chip-fanstudio"),
    statusChipHuania: requiredQuery(root, "#status-chip-huania"),
    statusSourceWolfx: requiredQuery(root, "#status-source-wolfx"),
    statusSourceFanstudio: requiredQuery(root, "#status-source-fanstudio"),
    statusSourceHuania: requiredQuery(root, "#status-source-huania"),
